...
def tail_points(opponent_score):
    ...
    eliminates_ones_digit = opponent_score // 10
    tens = eliminates_ones_digit % 10
...
def play(strategy0, strategy1, update,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            dice_num1 = strategy0(score0, score1)
            score0 = update(dice_num1, score0, score1, dice)
        else:
            dice_num2 = strategy1(score1, score0)
            score1 = update(dice_num2, score1, score0, dice)
        who = 1 - who
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    Play it safe when in lead and go yolo when losing
    """
    # BEGIN PROBLEM 12
    if score >= opponent_score:
        return 3
